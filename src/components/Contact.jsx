        ...
        <div className='pb-8 pt-20 '>
            ...
            <div className=' flex justify-center items-center'>
                <form action="https://getform.io/f/fa2458c3-afa7-48d1-bbb2-5b5c84867003" method="POST" className='flex flex-col w-full md:w-1/2'>
                    ...
                    <input type='text' name='email' placeholder='Type your email' required className=' my-2 p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'/>
                    <textarea name='message' placeholder='Type you message' rows={10}  required className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'></textarea>
